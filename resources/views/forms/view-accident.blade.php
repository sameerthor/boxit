...
<div class="row incident_form">
    <table class="table table-bordered">
        <tbody>
            ...
            <tr style="height: 30px;">
                ...
                <th style="width:45%;background-color:#c9ced6;">Date: <input type="date" readonly style="width:70%;background-color: #c9ced6;" value="{{ $incident_data!=null ? $incident_data->date : '' }}" name="incident_data[date]" value=""></th>
            </tr>
    ...
    <table class="table table-bordered single-table">
        <tbody>
            ...
            <tr>
                <td style="width: 60%"><textarea readonly name="incident_data[action_1]">{{ $incident_data!=null ? $incident_data->action_1 : '' }}</textarea></td>
                <td></td>
                <td style="width: 20%"><input readonly name="incident_data[whom_1]" value="{{ $incident_data!=null ? $incident_data->whom_1 : '' }}" type="text"></td>
                <td style="width: 20%"><input readonly name="incident_data[when_1]" value="{{ $incident_data!=null ? $incident_data->when_1 : '' }}" type="date"></td>
            </tr>
            <tr>
                <td style="width: 60%"><textarea name="incident_data[action_2]">{{ $incident_data!=null ? $incident_data->action_2 : '' }}</textarea></td>
                <td></td>
                <td style="width: 20%"><input readonly name="incident_data[whom_2]" value="{{ $incident_data!=null ? $incident_data->whom_2 : '' }}" type="text"></td>
                <td style="width: 20%"><input readonly name="incident_data[when_2]" value="{{ $incident_data!=null ? $incident_data->when_2 : '' }}" type="date"></td>
            </tr>
            <tr>
                <td style="width: 60%"><textarea name="incident_data[action_3]">{{ $incident_data!=null ? $incident_data->action_3 : '' }}</textarea></td>
                <td></td>
                <td style="width: 20%"><input readonly name="incident_data[whom_3]" value="{{ $incident_data!=null ? $incident_data->whom_3 : '' }}" type="text"></td>
                <td style="width: 20%"><input readonly name="incident_data[when_3]" value="{{ $incident_data!=null ? $incident_data->when_3 : '' }}" type="date"></td>
            </tr>
            <tr>
...
<script>
    $(".incident_form :input").prop("disabled", true);
    $(".incident_form :radio").prop("disabled", true);
    $(".incident_form :checkbox").prop("disabled", true);
    $(".incident_form :textarea").prop("disabled", true);
</script>