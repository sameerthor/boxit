    ...
    <div class="row">
      ...
      <div class="form-group col-md-12">
        ...
        <label class="checkbox-inline" for="status-15">
          <input type="checkbox" class="checked_type" {{in_array('15',$checked_checkbox_status)?'checked':''}} name="checkbox_status[]" id="status-15" value="15">ND Testing Received
          <span class="check"></span>
        </label>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-right">
            ...
            <button type="button" data-id="{{$res->id}}" class="btn btn-sm reorder" style="background-color: #172b4d;color:#fff">Reorder</button>
          </td>
          @endif
        </tr>
        @endforeach
