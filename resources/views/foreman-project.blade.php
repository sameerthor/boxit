    ...
    <div class="card-new ptb-50">
      ...
      <div class="row">
        ...
        <form method="get" id="filterForm" action="{{url('check-list')}}">
              <div class="row">
                <div class="col-md-4">
                 <a href="{{url('check-list')}}?completed_projects=<?php echo request()->get('completed_projects') == 1?0:1 ;?>" class="form-control {{request()->get('completed_projects') == 1? 'active_completed_button' : ''}}" id="completed_button">Completed Projects</a>
